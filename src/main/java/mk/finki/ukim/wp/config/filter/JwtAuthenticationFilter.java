package mk.finki.ukim.wp.config.filter;
...
import mk.finki.ukim.wp.config.JwtAuthConstants;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public String generateJwt(HttpServletResponse response, Authentication authResult) throws JsonProcessingException {
        ...
        String token = JWT.create()
                .withSubject(new ObjectMapper().writeValueAsString(UserDetailsDto.createOf(userDetails)))
